...
public class AC_News extends mBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datas.add(new News("ok3跨应用",TestUrls.accross_app));
        datas.add(new News("和彩云大文件下载",TestUrls.hcy_large));
        datas.add(new News("大文件下载读流",TestUrls.hcy_large));
